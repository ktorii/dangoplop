...
namespace TwoDLaserPack
{
    public class SpriteLaserSettingsDemoScene : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpriteBasedLaser == null) Debug.LogError("You need to reference a valid LineBasedLaser on this script.");
        ...
        private void OnButtonClick()
        {
            ...
            // Re-initialise the sprite laser with new prefab pieces
